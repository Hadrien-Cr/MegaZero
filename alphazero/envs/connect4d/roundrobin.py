...
from alphazero.envs.connect4d.train import args, Game
from alphazero.envs.connect4d.pit_config import *
import numpy as np
import pprint
import choix
...
if __name__ == '__main__':
    ...
    assert Path('experiments/connect4d').exists()
    print('Beginning round robin')
    networks = sorted(glob('experiments/connect4d/*/*.pkl'), reverse=True)
